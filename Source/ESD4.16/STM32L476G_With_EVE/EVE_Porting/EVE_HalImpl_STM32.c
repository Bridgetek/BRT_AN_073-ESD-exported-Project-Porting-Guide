...
#if defined(STM32L476xx)/* Initialize HAL platform */
...
#define EVE_CS_ACTIVE()        { HAL_GPIO_WritePin(GPIOE, GPIO_PIN_8, GPIO_PIN_RESET);}
#define EVE_CS_DEACTIVE()      { HAL_GPIO_WritePin(GPIOE, GPIO_PIN_8, GPIO_PIN_SET);}
...
void EVE_Mcu_release() {/* no-op */}
void EVE_Mcu_initialize()  {/* no-op */}
void EVE_Millis_initialize()  {/* no-op */}
void EVE_Millis_release()  {/* no-op */}
void EVE_HalImpl_initialize()  {/* no-op */}
void EVE_Util_closeFile(EVE_HalContext *phost)  {/* no-op */}
bool EVE_Util_loadImageFile(EVE_HalContext *phost, uint32_t address, const char *filename, uint32_t *format)  {/* no-op */}
bool EVE_Util_loadInflateFile(EVE_HalContext *phost, uint32_t address, const char *filename)  {/* no-op */}
bool EVE_Util_loadRawFile(EVE_HalContext *phost, uint32_t address, const char *filename)  {/* no-op */}
bool EVE_Util_loadSdCard(EVE_HalContext *phost)  {/* no-op */}
bool EVE_Util_loadMediaFile(EVE_HalContext *phost, const char *filename, uint32_t *transfered)  {/* no-op */}
bool EVE_Util_sdCardReady(EVE_HalContext *phost) {/* no-op */}
size_t EVE_Util_readFile(EVE_HalContext *phost, uint8_t *buffer, size_t size, const char *filename) {/* no-op */}
