...
#define Ft_Esd_TextBox_CLASSID 0x15932184
ESD_SYMBOL(Ft_Esd_TextBox_CLASSID, Type = esd_classid_t)

/* Multiple line Text Widget */
ESD_WIDGET(Ft_Esd_TextBox, Include = "Ft_Esd_TextBox.h", Callback, DisplayName = "ESD TextBox", Category = EsdWidgets, Icon = ":/icons/ui-labels.png", X = 0, Y = 0, Width = 400, Height = 300)
typedef struct
{
	union
	{
