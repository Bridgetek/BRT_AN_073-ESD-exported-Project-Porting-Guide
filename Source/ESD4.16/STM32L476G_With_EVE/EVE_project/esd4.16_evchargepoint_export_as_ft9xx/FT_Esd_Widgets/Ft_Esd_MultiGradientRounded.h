...
ESD_WIDGET(Ft_Esd_MultiGradientRounded, Include = "Ft_Esd_MultiGradientRounded.h", Callback, DisplayName = "ESD Multi Gradient (Rounded)", Category = EsdBasicWidgets, Icon = ":/icons/gradient.png", X = 0, Y = 0, Width = 400, Height = 300)
typedef struct
{
	union
	{
