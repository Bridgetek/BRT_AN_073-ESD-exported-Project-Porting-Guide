...
ESD_WIDGET(Ft_Esd_Gradient, Include = "Ft_Esd_Gradient.h", Callback, DisplayName = "Gradient Widget", Category = EsdWidgets, Icon = ":/icons/gradient.png", X = 0, Y = 0, Width = 400, Height = 300)
typedef struct
{
	union
	{
