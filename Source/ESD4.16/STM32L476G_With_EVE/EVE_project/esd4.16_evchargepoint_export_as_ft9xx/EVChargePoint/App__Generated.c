...
int ESD_Start()//main(int argc, char *argv[])
{
	Esd_Initialize();
	
	{
		...
		if (stat("EVChargePoint__Flash.bin", &st) == 0)
		{
#ifdef _WIN32
			wcscpy_s(ep.FlashFilePaths[ESD_FLASH_BT815], _countof(ep.FlashFilePaths[ESD_FLASH_BT815]), L"EVChargePoint__Flash.bin");
#if (EVE_SUPPORT_CHIPID >= EVE_BT817)
			wcscpy_s(ep.FlashFilePaths[ESD_FLASH_BT817], _countof(ep.FlashFilePaths[ESD_FLASH_BT817]), L"EVChargePoint__Flash.bin");
#endif
#endif
		}
#endif
