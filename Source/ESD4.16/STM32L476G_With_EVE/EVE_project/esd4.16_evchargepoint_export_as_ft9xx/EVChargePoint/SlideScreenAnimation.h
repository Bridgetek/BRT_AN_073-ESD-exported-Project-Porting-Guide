...
#ifndef SlideScreenAnimation__H
#define SlideScreenAnimation__H
...
ESD_ACTOR(SlideScreenAnimation, Include = "SlideScreenAnimation.h", Callback)
typedef struct
{
	void *Owner;
